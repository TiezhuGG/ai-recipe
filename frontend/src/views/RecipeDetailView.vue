<template>
  <div class="recipe-detail-view min-h-screen">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <!-- 返回按钮 -->
      <button 
        @click="router.back()"
        class="mb-4 sm:mb-6 flex items-center gap-2 text-gray-400 hover:text-primary-400 transition touch-target"
      >
      ...
      <div v-else-if="error" class="text-center py-12">
        ...
        <p class="mt-4 text-gray-400 text-sm sm:text-base">{{ error }}</p>
      </div>
